...
ObjetoCanvas.prototype.IniciarObjetoCanvas = function() {
    ...
    if (this.OpcionesCanvas['Entorno'] === 'Normal') {
        ...
        this.Textos = { 
            en  : [ "Loading..." , "Paused"  , "Start"  , "Frames per second" , "Full Screen"      , "Restore Screen"    , "Domino App by Richard", "Error loading WebGL"   ],
            es  : [ "Cargando...", "En Pausa", "Iniciar", "Frames por segundo", "Pantalla Completa", "Restaurar Pantalla", "Aplicación Domino de Richard", "Error iniciando WebGL" ],
            cat : [ "Carregan...", "En Pausa", "Iniciar", "Frames per segón"  , "Pantalla Completa", "Restaurar Pantalla", "Aplicación Domino de Richard", "Error inician WebGL"   ] 
        };
        ...
        if (this.OpcionesCanvas.BotonLogo === true) {
            /*StrHtml +=  "<a href='https://devildrey33.es' class='ObjetoCanvas_Boton' target='_blank' title='"+ this.Textos[this.OpcionesCanvas.Idioma][6] +"' id='ObjetoCavas_Logo'>" +
                    ...
                    "</div>" +
                "</a>";*/
            StrHtml += "<span class='ObjetoCanvas_Boton' style='width:25rem;text-align:center;display:flex;flex-direction:column;justify-content:center;'>Domino App by Richard</span>";
        }        
        StrHtml += "</div>";
